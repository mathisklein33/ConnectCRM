<div class="d-flex flex-column sidebar p-3">
    ...
    <ul class="nav flex-column mb-auto">
        ...
        <li>
            <a href="{{ route('tickets.index') }}" class="nav-link">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-ticket-perforated me-2" viewBox="0 0 16 16">
                    <path d="M0 4a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v1a1 1 0 0 0 0 2v1a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V7a1 1 0 0 0 0-2z"/>
                    <path d="M8 3.5A.5.5 0 0 1 8.5 4v8a.5.5 0 0 1-1 0V4a.5.5 0 0 1 .5-.5"/>
                </svg>
                Tickets
            </a>
        </li>
        <li>
            <a href="{{ route('save-files.index') }}" class="nav-link">
    ...
    <a href="{{ route('profile.index') }}" class="nav-link mt-4">
